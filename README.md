...
Валидация, подбор порогов, OOF, логи и checkpoint выполняются главным процессом;
результат валидации передаётся остальным. EMA и checkpoint сохраняются без префикса
